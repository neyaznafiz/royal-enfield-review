    ...
    return (
        <div className='pb-20'>
            ...
            <div className='mx-64 mt-20'>
                ...
                <p> A semantic tag is an HTML tag. HTML is a markup language. A semantic tag is that describes the meaning for the browser and developer clearly. As a developer we could understand which header is which footer, which is div and which is form but it would be a problem for search engine, So, to solve the problem, HTML-5 is bringing semantic tag by which these problems are solved,
                    And because of this, search engines understand it better. like if you want to create a form, you can use the div tag for this, then you can create a form, but, div defines that div is created a section for the form, then you can create form using form tag, form tag define the form area. here form tag is a semantic tag.</p>
            </div>
